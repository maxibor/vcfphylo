# nf/vcfphylo pipeline parameters
...
|-----------|-----------|-----------|-----------|-----------|-----------|
| `representative_genome` | Path to representative genome, used as backbone genome for variant calling <details><summary>Help</summary><small>In fasta.gz 
format</small></details>| `string` |  |  |  |
